...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
                ...
                color: Colors.amber,
                child: ListTile(
                  leading: _stalkerModel.coWorkers[index].location == WorkerLocations.home
                      ? new Icon(Icons.home)
                      : _stalkerModel.coWorkers[index].location == WorkerLocations.office
      ...
      floatingActionButton: FloatingActionButton(onPressed: _incrementCounter, tooltip: 'Increment', child: Icon(Icons.add_to_home_screen)),
                      ...
                      MaterialPageRoute(
                        builder: (context) => PlacePicker(
                          ...
                          onPlacePicked: (result) {
                            ...
                            _stalkerModel.homeLocation = Location.fromJson(result.geometry.location.toJson());
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PlacePicker(
                          ...
                          onPlacePicked: (result) {
                            //print(result.address);
                            _stalkerModel.workLocation = Location.fromJson(result.geometry.location.toJson());
                            Navigator.of(context).pop();
                          },
                          initialPosition: kInitialPosition, //probably should be updated to the last chosen work location
                          useCurrentLocation: true,
                        ),
                      ),
                    );
