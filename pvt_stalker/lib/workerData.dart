...
class Location extends LatLng {
  ...
  Location.fromJson(Map<String, dynamic> json) : super(json['lat'] as double, json['lng'] as double);
...
final fakeCoWorkers = [
  new CoWorker(username: "Razan", location: WorkerLocations.office, lastUpdate: DateTime.now()),
  new CoWorker(username: "Barry", location: WorkerLocations.office, lastUpdate: DateTime.parse("2020-01-20 14:23:04Z")),
  new CoWorker(username: "Airi", location: WorkerLocations.unknown, lastUpdate: DateTime.parse("2020-01-19 10:10:04Z")),
  new CoWorker(username: "Jakob", location: WorkerLocations.home, lastUpdate: DateTime.parse("2020-01-15 22:10:04Z")),
  new CoWorker(username: "Katie", location: WorkerLocations.unknown, lastUpdate: DateTime.parse("2020-01-22 09:01:04Z"))
];
